"""
Django settings for qnode10_app project.
...
WAGTAILIMAGES_MAX_UPLOAD_SIZE = 100 * 10000 * 10000  # i.e. 20MB
WAGTAILIMAGES_MAX_IMAGE_PIXELS = 500000000000  # i.e. 500 megapixels
...
WSGI_APPLICATION = 'qnode12_app.wsgi.application'
